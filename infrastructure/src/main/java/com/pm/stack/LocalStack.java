...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService = createFargateService(
                ...
                List.of(4005),
                authServiceDb,
                Map.of("JWT_SECRET", "a52047b06aea1436534436ceff7ff8e7440c86615012370d7653bea2")
        );
    ...
    private DatabaseInstance createDatabase(String id, String dbName) {
        return DatabaseInstance.Builder
                ...
                .allocatedStorage(20)
                .credentials(Credentials.fromGeneratedSecret("developer"))
                .databaseName(dbName)
    ...
    private FargateService createFargateService(
        ...
        // Corrected Kafka bootstrap servers
        envVars.put("SPRING_KAFKA_BOOTSTRAP_SERVERS",
                "host.docker.internal:9092,localhost.localstack.cloud:4510,localhost.localstack.cloud:4511,localhost.localstack.cloud:4512");
        ...
        if (db != null) {
            ...
            envVars.put("SPRING_DATASOURCE_USERNAME", "developer");
